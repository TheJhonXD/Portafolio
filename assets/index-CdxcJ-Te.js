...
`;function m2({duration:e=1e3,delay:t=0,timingFunction:n="ease",keyframes:r=p0,iterationCount:o=1}){return a0`
  ...
  `}function h2(e){return e==null}function v2(e){return typeof e=="string"||typeof e=="number"||typeof e=="boolean"}function m0(e,t){return n=>n?e():t()}function wr(e){return m0(e,()=>null)}function es(e){return wr(()=>({opacity:0}))(e)}const ia=e=>{const{cascade:t=!1,damping:n=.5,delay:r=0,duration:o=1e3,fraction:l=0,keyframes:i=p0,triggerOnce:s=!1,className:a,style:f,childClassName:h,childStyle:m,children:v,onVisibilityChange:w}=e,x=T.useMemo(()=>m2({keyframes:i,duration:o}),[o,i]);return h2(v)?null:v2(v)?ee(y2,{...e,animationStyles:x,children:String(v)}):p2.isFragment(v)?ee(h0,{...e,animationStyles:x}):ee(e2,{children:T.Children.map(v,(g,z)=>{if(!T.isValidElement(g))return null;const d=r+(t?z*o*n:0);switch(g.type){case"ol":case"ul":return ee(ql,{children:({cx:u})=>ee(g.type,{...g.props,className:u(a,g.props.className),style:Object.assign({},f,g.props.style),children:ee(ia,{...e,children:g.props.children})})});case"li":return ee(ju,{threshold:l,triggerOnce:s,onChange:w,children:({inView:u,ref:p})=>ee(ql,{children:({cx:y})=>ee(g.type,{...g.props,ref:p,className:y(h,g.props.className),css:wr(()=>x)(u),style:Object.assign({},m,g.props.style,es(!u),{animationDelay:d+"ms"})})})});default:return ee(ju,{threshold:l,triggerOnce:s,onChange:w,children:({inView:u,ref:p})=>ee("div",{ref:p,className:a,css:wr(()=>x)(u),style:Object.assign({},f,es(!u),{animationDelay:d+"ms"}),children:ee(ql,{children:({cx:y})=>ee(g.type,{...g.props,className:y(h,g.props.className),style:Object.assign({},m,g.props.style)})})})})}})})},g2={display:"inline-block",whiteSpace:"pre"},y2=e=>{const{animationStyles:t,cascade:n=!1,damping:r=.5,delay:o=0,duration:l=1e3,fraction:i=0,triggerOnce:s=!1,className:a,style:f,children:h,onVisibilityChange:m}=e,{ref:v,inView:w}=c0({triggerOnce:s,threshold:i,onChange:m});return m0(()=>ee("div",{ref:v,className:a,style:Object.assign({},f,g2),children:h.split("").map((x,g)=>ee("span",{css:wr(()=>t)(w),style:{animationDelay:o+g*l*r+"ms"},children:x},g))}),()=>ee(h0,{...e,children:h}))(n)},h0=e=>{const{animationStyles:t,fraction:n=0,triggerOnce:r=!1,className:o,style:l,children:i,onVisibilityChange:s}=e,{ref:a,inView:f}=c0({triggerOnce:r,threshold:n,onChange:s});return ee("div",{ref:a,className:o,css:wr(()=>t)(f),style:Object.assign({},l,es(!f)),children:i})};k`
  from,
  20%,
  40%,
  60%,
